...
import { getPostBySlug,getCategories,getPostsByType, getPostById } from '../../utils/Models';
            ...
            <div className="center">
                <div className="single_product_banner_in full_width">
                    <ul className="banner_list">
                        <li><a href="index.html">{tr_list.home_title}</a></li>
                        <li><span>/</span></li>
                        <li><a href="shop.html">{pageTop.title}</a></li>
                        <li><span>/</span></li>
                        <li className="product_title"><span>{post.title}</span></li>
                    </ul>
                </div>
                    ...
                    <div className="product_top full_width flex">
                        <div className="product_gallery">
                            <ul className="product_gallery_list">
                             ...
                             {
                                 postGallery && postGallery.map((item,key)=>{
                                     return(
                                        <li><img src={item} alt={post.title} /></li>
                                     )
                                 })
                             }
                        ...
                        <div className="product_content full_width">
                            <ul className="product_content_list flex direction_column">
                                ...
                                <li>
                                    ...
                                    {
                                        hasDiscount ? <>
                                            <span className="product_price"><del>${postMetas.price}</del></span>
                                            <span className="product_price">${discountPrice}</span>   
                                        </> :<span className="product_price">${postMetas.price}</span>
}</p>
                                </li>
                                <li>
                                        ...
                                        <ul className="add_cart_form_list flex">
                                           {
                                               (postMetas.stock > 3) ? <>
                                                ...
                                                <span className="quantity_label">Quantity</span>
                                                    ...
                                                    <input type="number" defaultValue={addBasketCount} min="1" onChange={(e)=>{setAddBasketCount(e.target.value)}}  max={postMetas.stock} className="qty_input" />
                                                 
                                                     
                             
                                            </li>
                                            <li>
                                                <button type="button" className="add_cart_btn" onClick={addBasket.bind(this,post.id,addBasketCount)}>Add to Cart</button>
                                            </li></>:<p>Sold out</p>
                                           }
                                        </ul>
                                    </form>
                                ...
                                <li>
                                    <button type="button" className="add_wishlist_btn" onClick={addWishlist.bind(this,post.id)}><i className="far fa-heart"></i><span>Add to wishlist</span></button>
                                </li>
                                <li className="product_meta flex direction_column">
                                    <span>SKU:059</span>
                                    <span>Category: <a href="#">Concept</a></span>
                                    <span>Tags:<a href="#">Boxes,</a><a href="#">Wood</a></span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="center">
                <div className="product_bottom_in full_width">
                    <div className="tabs full_width flex flex_wrap">
                            ...
                            <label for="description_tab" className="tabs_title desc_tab">Description</label>
                            ...
                            <input type="radio" id="additional_information_tab" name="myTabs"/>
                            <label for="additional_information_tab" className="tabs_title add_tab">Additional information</label>
                            <div className="tab full_width">
                            ...
                            <label for="reviews_tab" className="tabs_title review_tab">Reviews <span>(1)</span></label>
                            <div className="tab full_width">
                                <h2>
                                    1 review for
                                    ...
                                    <form className="full_width">
                                        <ul className="comment_form_list full_width flex direction_column">
                                            <li>
                                                ...
                                                <textarea id="commnet" cols="45" rows="8" className="textarea" required ></textarea>
                                            </li>
                                            <li>
                                                <label for="name">Name *</label>
                                                <input type="text" id="name"  className="comment_input" required />
                                            </li>
                                            <li>
                                                <label for="email">Email *</label>
                                                <input type="email" id="email"  className="comment_input" required />
                                            </li>
                                            <li>
                                                <input type="checkbox" id="check_input"  className="check_input" required />
                                                <label for="check_input" className="check_lable">Save my name, email, and website in this browser for the next time I comment.</label>
                                            </li>
                                            <li>
                                                <button type="submit" className="comment_btn">Submit</button>
                                            </li>
