                       ...
                       <div className="tabs flex flex_wrap">
                           ...
                           
                           {
                               tabs && tabs.map((item,key)=>{
                                  ...
                                  (key===0) ? checkValue=true:checkValue=false;
                    
                                   return(
                                       <>
                                        <input type="radio" id="about_tab" name="myTabs" defaultChecked={checkValue}/>
                                        <label htmlFor="about_tab" className="tab_lable">{item.title}</label>
                                        <div className="tab">
                                            <p>{item.excerpt}</p>
                                        </div>
                                       </>
                           ...
                           <span  className="flex align_center"><a href="#" className="learn_more">Learn more</a><i className="mkd-icon-linear-icon lnr lnr-arrow-right"></i></span>
                       </div>
                   </div>
                       ...
                       
                       {
                           posts && posts.map((item,key)=>{
                               return(
                                ...
                                <p>Vestibulum ultricies aliquam convallis. Maecenas uttellus mi. Proin tincidunt, lectus. Lorem ipsum dolor
                                    sit amet, consectetur elit. In ut ullamcorper leo, eget euismod orci. Cum sociis pena tibus et magnis 
                                    dis parturient montes, nascetur ipsum dolor sit amet.</p>
            ...
            <div className="center">
                <div className="our_team_in full_width">
                    ...
                    <ul className="team_list flex flex_wrap full_width">
                       ...
                       {
                           member && member.map((item,key)=>{
                               return(
                                <li>
                                <a href="#"><img src={item.featured} alt={item.title}/></a>
                                <h4><a href="#">{item.title}</a></h4>
                                <h6>{item.prof}</h6>
                                <p>{item.excerpt}</p>
                                <ul className="social_links flex justify_center">
                                    <li><a href="#"><i className={item.icon1}></i></a></li>
                                    <li><a href="#"><i className={item.icon2}></i></a></li>
                                    <li><a href="#"><i className={item.icon3}></i></a></li>
                                </ul>
                            </li>
                               )
                           })
